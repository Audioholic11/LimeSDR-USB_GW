...
begin
   if reset_n = '0' then 
      ...
      -- Packet data
      if in_pct_data_valid = '1' AND pct_data_wrreq_cnt > C_HEADER_POS AND pct_data_wrreq_cnt < (PCT_SIZE*8)/pct_data'length  - to_integer(unsigned'('0' & inst_chirp_sync_en)) then 
